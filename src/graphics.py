...
## Efficiently renders a part of the game kek with given settings.
#
#  The object of kekRenderer class keeps a reference to kek object
#  which it will be rendering. It keeps a pre-rendered image of the
#  kek's active area terrain so it can be rendered quickly for
#  real-time viewing. kekRenderer will smartly change the kek active
...
class kekRenderer:
  ...
  def view_top_left(self,value):
    ...
    # here the kek active area is being potentially changed if the view rectangle is at the border of the active area:
  ...
  def __init_attributes(self):
    ## prerendered terrain of the active part of the kek
  ...
  ## Private method that is called to change the kek active area and
  ...
  ## Renders the current kek view.
  #
  #  @return the image (Surface object) of the rendered kek area, its
  #          size is defined by VIEW_WIDTH and VIEW_HEIGHT constants,
  #          if the image couldn't be rendered (no kek assigned etc.),
  #          None is returned
